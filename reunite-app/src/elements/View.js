...
const View = styled.View`
  ...
  padding: ${props =>
    scaledValues(
      (props.boundary && [props.theme.spacing.boundary()]) || props.pd || [0],
    )};
  ...
  justify-content: ${props =>
    (props.row && 'space-between') || props.jc || 'flex-start'};
  ${props =>
    props.shadow &&
    `shadow-color: #000; shadow-offset: 0px 2px; shadow-opacity: 0.30; shadow-radius: 2px; elevation: ${
      props.shadow || 1
    };`}
`;
